        ...
        <div class="text-right" style="margin-right: 5px;">
            <div class="col-sm-4-4">
                <ul class="pagination pagination-lg">
                  ...
                  <li><a style="font-size: 32px;" href="frames.jsp">Frames</a></li>
...
<div class="text-center">
    <%
    String path2 = "C://Users//Nahla//Documents//NetBeansProjects//NHandmadeCrafts//web//WEB-INF//garlands";
    File folder = new File(path2);
    File[] listOfFiles = folder.listFiles();
    ArrayList paths = new ArrayList();
    for(int i=0;i<listOfFiles.length;i++)
    {
        paths.add("http://127.0.0.1:8887/web/WEB-INF/garlands/"+"/"+listOfFiles[i].getName());
    }
    int index = 0;
    double loop = 0.0;
    if((paths.size()%3) == 0)
