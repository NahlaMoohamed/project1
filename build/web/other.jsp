...
<div class="container" style="margin-bottom: 5px; margin-top: 5px;">
    ...
    <div class="text-center">
        <%
        String path2 = "C://Users//Nahla//Documents//NetBeansProjects//NHandmadeCrafts//web//WEB-INF//other";
        File folder = new File(path2);
        File[] listOfFiles = folder.listFiles();
        ArrayList paths = new ArrayList();
        for(int i=0;i<listOfFiles.length;i++)
        {
            paths.add("http://127.0.0.1:8887/web/WEB-INF/other/"+listOfFiles[i].getName());
        }
        int index = 0;
        double loop = 0.0;
        if((paths.size()%3) == 0)
